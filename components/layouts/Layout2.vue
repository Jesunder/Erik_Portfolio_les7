...
<template>
  <div class="layout2">
    ...
    <div class="relative max-h-screen overflow-hidden z-1">
      ...
      <div
        class="absolute inset-0 flex flex-col items-center justify-center bg-slate-700 bg-opacity-70 animate-fade animate-once animate-delay-[500ms]"
        v-if="imageLoaded"
      >
    ...
    <div class="container mx-auto p-4 animate-fade animate-once animate-delay-[500ms]" v-if="imageLoaded">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-10 mt-6">
        ...
        <div>
          ...
          <p class="text-lg md:text-2xl lg:text-xl pb-5 font-medium">{{ data.description }}</p>
